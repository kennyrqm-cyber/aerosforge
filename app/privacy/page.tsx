  ...
  return <main>
    <section className="section policyPage">
      ...
      <div className="card policyCopy">
        ...
        <p>Account features may store your name, email address, authentication records, learning progress, badges, scenario attempts, Checkride Baseline self-ratings and reflection, and profile information you choose to provide. Assigned CFIs and authorized administrators may view baseline results to support study planning.</p>
