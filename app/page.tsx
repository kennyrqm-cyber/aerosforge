  ...
  return <main>
    <section className="hero">
      <div>
        ...
        <div style={{display:"flex",gap:10,flexWrap:"wrap"}}><Link className="button primary" href="/sign-up">Create free account →</Link><Link className="button" href="/winchester">Winchester 2027 pathway</Link></div>
      </div>
